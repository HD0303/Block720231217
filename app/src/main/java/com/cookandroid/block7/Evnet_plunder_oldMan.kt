...
class Evnet_plunder_oldMan(GameActivity: GameActivity, eventName: String, weight: Int, isAvailable: Boolean) :
    ...
    init {
        a.events_exploring.add(this)
        super.setPreScript(a.getScript("evnet_plunder_oldMan_pre"))
        super.setPostScript(a.getScript("evnet_plunder_oldMan_post"))
    }
    ...
    override fun eventEffect(tmp: Int) {
        if(tmp == 1) { // 문을 열어준 경우
            ...
            setPreScript(a.getScript("evnet_plunder_oldMan_post_tmp"))
        }
    }
}