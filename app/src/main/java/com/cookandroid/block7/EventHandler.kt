...
class EventHandler(GameActivity: GameActivity) {
    ...
    /* 이벤트 객체 생성 */
    // 침입 - 강도
    var event_invasion_robbery = Event_invasion_robbery(GameActivity, "event_invasion_robbery", defaultWeight, defaultIsAvailable)
    // 침입 - 할머니
    var event_invasion_grandma = Event_invasion_grandma(GameActivity, "event_invasion_grandma", defaultWeight, defaultIsAvailable)
    // 침입 - 소방관
    var event_invasion_firefighter = Event_invasion_firefighter(GameActivity, "event_invasion_firefighter", defaultWeight, defaultIsAvailable)
    // 약탈 - 노인
    var evnet_plunder_oldMan = Evnet_plunder_oldMan(GameActivity, "evnet_plunder_oldMan", defaultWeight, defaultIsAvailable)
