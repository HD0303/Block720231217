...
class GameActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        page1to2button.setOnClickListener{
            survival_note_page1.visibility = View.GONE
            survival_note_page2.visibility = View.VISIBLE
        }

        page2to3button.setOnClickListener{
            survival_note_page2.visibility = View.GONE
            survival_note_page3.visibility = View.VISIBLE
        }


        page3to4button.setOnClickListener{
            survival_note_page3.visibility = View.GONE
            survival_note_page4.visibility = View.VISIBLE
        }

        page4to3button.setOnClickListener{
            survival_note_page3.visibility = View.VISIBLE
            survival_note_page4.visibility = View.GONE
        }

        page3to2button.setOnClickListener{
            survival_note_page2.visibility = View.VISIBLE
            survival_note_page3.visibility = View.GONE
        }

        page2to1button.setOnClickListener{
            survival_note_page1.visibility = View.VISIBLE
            survival_note_page2.visibility = View.GONE
        }
